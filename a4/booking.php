        ...
        <div class='booking-form-content'>
          ...
          <form action='booking.php?movie=<?= $currentMovie?>' method='POST'>
            ...
            <fieldset class='seat-set'>
              ...
              <button class="plus" onClick="plusButton('STA', event, 'subTotalSTA')">+</button>
              <div id="subTotalSTA"></div><br />
              ...
              <button class="plus" onClick="plusButton('STP', event, 'subTotalSTP')">+</button>
              <div id="subTotalSTP"></div><br />
              ...
              <button class="plus" onClick="plusButton('STC', event, 'subTotalSTC')">+</button>
              <div id="subTotalSTC"></div><br />
            </fieldset>
            <fieldset class='seat-set'>
              ...
              <button class="plus" onClick="plusButton('FCA', event, 'subTotalFCA')">+</button>
              <div id="subTotalFCA"></div><br />
              ...
              <button class="plus" onClick="plusButton('FCP', event, 'subTotalFCP')">+</button>
              <div id="subTotalFCP"></div><br />
              ...
              <button class="plus" onClick="plusButton('FCC', event, 'subTotalFCC')">+</button>
              <div id="subTotalFCC"></div><br />
              <?= $seatsError ?>
            </fieldset>
